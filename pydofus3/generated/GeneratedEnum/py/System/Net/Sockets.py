...
class IPProtectionLevel(IntFlag):
    Unspecified = -1
    Unrestricted = 10
    EdgeRestricted = 20
    Restricted = 30
...
class SocketAsyncOperation(IntFlag):
    NONE = 0
    Accept = 1
    Connect = 2
    Disconnect = 3
...
class SocketOptionLevel(IntFlag):
    Socket = 65535
    IP = 0
    IPv6 = 41
    Tcp = 6
...
class SocketOptionName(IntFlag):
    Debug = 1
    AcceptConnection = 2
    ReuseAddress = 4
    KeepAlive = 8
