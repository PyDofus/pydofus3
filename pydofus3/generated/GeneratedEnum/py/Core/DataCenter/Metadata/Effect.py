...
# Core.DataCenter.Metadata.Effect.ActionId
class ActionId(IntFlag):
    NoOperation = 0
...
# Core.DataCenter.Metadata.Effect.EffectInstanceData
class EffectInstanceData(IntFlag):
    UndefinedCategory = -2
    UndefinedShow = -1

# Core.DataCenter.Metadata.Effect.EffectInstanceFlags
