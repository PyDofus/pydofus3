...
# IKVM.Reflection.Emit.AssemblyBuilderAccess
class AssemblyBuilderAccess(IntFlag):
    Save = 2
    ReflectionOnly = 6

# IKVM.Reflection.Emit.FlowControl
...
# IKVM.Reflection.Emit.KnownCA
class KnownCA(IntFlag):
    Unknown = 0
...
# IKVM.Reflection.Emit.OpCodeType
...
# IKVM.Reflection.Emit.OperandType
...
# IKVM.Reflection.Emit.PEFileKinds
class PEFileKinds(IntFlag):
    Dll = 1
    ConsoleApplication = 2
    WindowApplication = 3

# IKVM.Reflection.Emit.PackingSize
class PackingSize(IntFlag):
    Unspecified = 0
    Size1 = 1
    Size2 = 2
    Size4 = 4
...
# IKVM.Reflection.Emit.StackBehaviour
class StackBehaviour(IntFlag):
    Pop0 = 0
    Pop1 = 1
    Pop1_pop1 = 2
    Popi = 3
