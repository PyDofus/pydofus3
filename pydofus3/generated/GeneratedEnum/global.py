...
class dsl:
	...
	class EncyclopediaTab(IntEnum):
		Equipment = 0
		Resource = 1
		Consumable = 2

	class EstateAgencyTab(IntEnum):
		House = 0
		Paddocks = 1
...
class FlashFilterRenderFeature:
	class grw(IntEnum):
		dtfv = 0
		dtfw = 1
		dtfx = 2
...
class Interop:
	class Kernel32:
		...
		class FINDEX_INFO_LEVELS(IntEnum):
			FindExInfoStandard = 0
			FindExInfoBasic = 1
			FindExInfoMaxInfoLevel = 2

		class FINDEX_SEARCH_OPS(IntEnum):
			FindExSearchNameMatch = 0
			FindExSearchLimitToDirectories = 1
			FindExSearchLimitToDevices = 2
			FindExSearchMaxSearchOp = 3

		class GET_FILEEX_INFO_LEVELS(IntEnum):
	...
	class NtDll:
		...
		class ObjectAttributes(IntFlag):
			OBJ_INHERIT = 2
			OBJ_PERMANENT = 16
			OBJ_EXCLUSIVE = 32
