...
from pydofus3.generated.pydantic.AleCore.Data.UnityClient.ClientLayer import ClientLayer
...
class ClientParticlesParameters(MyBaseModel):
	...
	gfxId: int
	materialIndex: int
	materialIsStagingTarget: bool
	materialStagingId: str
	trailGfxId: int
	trailMaterialIndex: int
	trailMaterialIsStagingTarget: bool
	trailMaterialStagingId: str
	layer: Annotated[Union[ClientLayer, int], Field(union_mode='left_to_right')]
	displayOrder: int
	cellId: int
