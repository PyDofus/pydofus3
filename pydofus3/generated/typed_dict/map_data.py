...
class Material(TypedDict):
    pass
class ParticleSystem(TypedDict):
    pass
class Texture2D(TypedDict):
    pass

class Ale2ConstantsOrCurves(TypedDict):
    constantMin: float
    constantMax: float
...
class Ale2ConstantsOrCurvesHideMode(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleAlphaKey(TypedDict):
    alpha: float
    time: float

class AleAnimationCurve(TypedDict):
    keys: list[AleKeyframe]

class AleBurst(TypedDict):
    time: float
...
class AleColor(TypedDict):
    value: int

class AleColorKey(TypedDict):
    color: AleColor
    time: float

class AleConstantOr2Constants(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleConstantOrCurve(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleCurveHideMode(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleGradient(TypedDict):
    colorKeys: list[AleColorKey]
    alphaKeys: list[AleAlphaKey]

class AleGradients(TypedDict):
    colorMin: AleColor
    colorMax: AleColor
...
class AleMatrix4x4(TypedDict):
    column0: AleVector4
    column1: AleVector4
    column2: AleVector4
    column3: AleVector4

class AleMinMaxCurve(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleMinMaxCurveHideMode(TypedDict):
    constantMin: float
    constantMax: float
    curveMin: AleAnimationCurve
    curveMax: AleAnimationCurve
...
class AleMinMaxGradient(TypedDict):
    colorMin: AleColor
    colorMax: AleColor
    gradientMin: AleGradient
    gradientMax: AleGradient
...
class AleParticleSystemNoiseQuality(TypedDict):
    noiseQuality: int

class AleParticleSystemRenderMode(TypedDict):
    renderMode: int

class AleParticleSystemRenderSpace(TypedDict):
    renderSpace: int

class AleParticleSystemShapeMultiModeValue(TypedDict):
    multiModeValue: int

class AleParticleSystemShapeType(TypedDict):
    shapeType: int

class AleParticleSystemSortMode(TypedDict):
    sortMode: int

class AleParticleSystemTrailTextureMode(TypedDict):
    textureMode: int

class AleRect(TypedDict):
    x: float
    y: float
    width: float
    height: float

class AleVector2(TypedDict):
    x: float
    y: float

class AleVector2Int(TypedDict):
    x: int
    y: int

class AleVector3(TypedDict):
    x: float
    y: float
    z: float

class AleVector4(TypedDict):
    x: float
    y: float
    z: float
    w: float

class AnimatedElement(TypedDict):
    m_id: int
    m_type: int
    m_entityLook: str
...
class ClientInteractiveElementTransform(TypedDict):
    gfxId: int
    color: AleColor
    transform: Transform2D
    materialIndex: int
...
class ClientMapElement(TypedDict):
    position: AleVector2
    rotation: float
    scale: AleVector2
    color: AleColor
...
class DissolveStagingEffect(TypedDict):
    material: PPtr
...
class DistortionStagingEffect(TypedDict):
    material: PPtr
...
class ElementAtlas(TypedDict):
    width: int
    height: int
    idsToRects: AtlasDictionary

class EmissiveStagingEffect(TypedDict):
    material: PPtr
    factor: StagingEvolutiveVar

class FmodParameterValue(TypedDict):
    name: str
    value: float

class GfxElement(TypedDict):
    m_id: int
    m_type: int
    m_gfxId: int
    m_height: int
...
class LocalizedSound(TypedDict):
    audioEvent: str
    position: AleVector2
...
class MapMetadata(MonoBehaviour):
    ...
    mapTextures: list[PPtr]
    allowMapEffects: int

class MapNoiseModifierConfiguration(TypedDict):
    noiseModifierParameters: NoiseModifierParameters

class MapPostProcessConfiguration(TypedDict):
    postProcessParameters: list[Union[PPBloomParameters| PPChromaticAberrationParameters| PPFilmGrainParameters]]

class MapWaveConfiguration(TypedDict):
    waveParameters: WaveParameters

class MapWindConfiguration(TypedDict):
...
class NoAnimAlphaStagingEffect(TypedDict):
    material: PPtr
    effectDisplay: int
    alpha: StagingEvolutiveVar
    color: StagingEvolutiveVar

class NoiseModifierParameters(TypedDict):
...
class PPBloomParameters(TypedDict):
    threshold: float
    intensity: float
    scatter: float
    color: AleColor

class PPChromaticAberrationParameters(TypedDict):
    intensity: float

class PPFilmGrainParameters(TypedDict):
    type: int
    intensity: float
    response: float

class PaintShaderData(TypedDict):
...
class ParticleEmissionBurstStagingParameters(TypedDict):
    burstIndex: int
...
class ParticleEmissionStagingEffect(TypedDict):
    particlesSystem: PPtr
    rateOverTime: StagingEvolutiveVar
    bursts: list[ParticleEmissionBurstStagingParameters]

class ParticleMainStagingEffect(TypedDict):
    particlesSystem: PPtr
    startColor: StagingEvolutiveVar

class ParticleSpritesheetParameters(TypedDict):
    tiles: AleVector2Int
    frameOverTime: AleMinMaxCurve
    startFrame: AleConstantOr2Constants
    cycles: int

class ParticlesColorOverLifetimeParameters(TypedDict):
    colorOverLifetimeColor: AleGradients

class ParticlesEmissionParameters(TypedDict):
    rateOverTime: AleMinMaxCurve
    bursts: list[AleBurst]

class ParticlesMainParameters(TypedDict):
    duration: float
    looping: int
    prewarm: int
...
class ParticlesModulesParameters(TypedDict):
...
class ParticlesNoiseParameters(TypedDict):
...
class ParticlesPlayStagingEffect(TypedDict):
    particlesSystem: PPtr

class ParticlesRendererParameters(TypedDict):
...
class ParticlesRotationOverLifetimeParameters(TypedDict):
...
class ParticlesShaderData(TypedDict):
    shaderParameters: list[Union[ShaderBlendingParameters| ShaderColorAnimationParameters| ShaderCustomFramerateParameters| ShaderDepthAlphaClipParameters| ShaderDissolveParameters| ShaderDistortionParameters| ShaderEmissiveParameters| ShaderRefractionParameters| ShaderRotationParameters| ShaderScaleParameters| ShaderTextureOffsetParameters| ShaderTranslationParameters| ShaderWaveParameters| ShaderWindParameters]]
    gfxId: int
    unique: int
    isStagingTarget: int
...
class ParticlesShapeParameters(TypedDict):
...
class ParticlesSizeOverLifetimeParameters(TypedDict):
...
class ParticlesSoundParameters(TypedDict):
    maxParticles: int
    spawnFmodEvent: str
    deathFmodEvent: str

class ParticlesStopStagingEffect(TypedDict):
    particlesSystem: PPtr
    clear: int

class ParticlesSubEmittersParameters(TypedDict):
    parentId: str
    type: int
    properties: int
    emitProbability: float

class ParticlesTrailsParameters(TypedDict):
    trailsRatio: float
...
class ParticlesVelocityOverLifetimeParameters(TypedDict):
...
class PlayFmodEventStagingEffect(TypedDict):
    fmodEvent: str
...
class RotationStagingEffect(TypedDict):
    material: PPtr
...
class ScaleStagingEffect(TypedDict):
    material: PPtr
...
class SequenceEventStagingEffect(TypedDict):
    stagingEventType: int

class SetFmodParamStagingEffect(TypedDict):
    paramName: str
    endValue: StagingEvolutiveVar

class ShaderBlendingParameters(TypedDict):
    sourceFactor: int
    blendOperation: int
    destinationFactor: int

class ShaderColorAnimationParameters(TypedDict):
...
class ShaderCustomFramerateParameters(TypedDict):
    framerate: float
...
class ShaderDissolveParameters(TypedDict):
    dissolveTexID: int
...
class ShaderDistortionParameters(TypedDict):
    noiseTexID: int
    noiseTexUVMode: int
...
class ShaderEmissiveParameters(TypedDict):
    emissiveTexID: int
    color: AleColor
    factor: float
...
class ShaderOutlineParameters(TypedDict):
    type: int
    testDiff: int
    alphaClip: float
    color: AleColor

class ShaderRefractionParameters(TypedDict):
    noiseTexID: int
    noiseTexUVMode: int
    noiseTexTiling: AleVector2
    tile: float
...
class ShaderRotationParameters(TypedDict):
    animationCurveType: int
...
class ShaderScaleParameters(TypedDict):
    animationCurveType: int
    axes: AleVector2
    pivot: AleVector2
    frequency: float
...
class ShaderTextureOffsetParameters(TypedDict):
...
class ShaderTranslationParameters(TypedDict):
    animationCurveType: int
    direction: AleVector2
    frequency: float
    linkFrequencyToWind: int
...
class ShaderWaveParameters(TypedDict):
    waveTexID: int

class ShaderWindParameters(TypedDict):
...
class ShaderWindParentParameters(TypedDict):
    bendCenter: AleVector2
    bendStart: AleVector2
    bendAxe: AleVector2
    bendAxeMultiplier: float
...
class ShowMapAnimatedElementStagingEffect(TypedDict):
    show: int

class StagingEffectsPack(TypedDict):
    targets: list[str]
    stagingEffects: list[Union[PlayFmodEventStagingEffect| SequenceEventStagingEffect| SetFmodParamStagingEffect| StopLocalizedFmodEventsStagingEffect| ColorAnimationStagingEffect| DissolveStagingEffect| DistortionStagingEffect| EmissiveStagingEffect| NoAnimAlphaStagingEffect| RotationStagingEffect| ScaleStagingEffect| TranslationStagingEffect| ParticleEmissionStagingEffect| ParticleMainStagingEffect| ParticlesPlayStagingEffect| ParticlesStopStagingEffect]]

class StagingEvolutiveVar(TypedDict):
    active: int
    startValue: float
    maxValue: float

class StagingSequence(TypedDict):
    id: str
    uniqueId: int
...
class StopLocalizedFmodEventsStagingEffect(TypedDict):
    fmodEvent: str
...
class TranslationStagingEffect(TypedDict):
    material: PPtr
...
class WaveParameters(TypedDict):
    waveFrequency: float
...
class WindParameters(TypedDict):
    windPower: float
    windModelTexID: int
